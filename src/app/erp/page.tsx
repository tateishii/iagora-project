            ...
            <section className={styles.hero}>
                <div className={styles.heroContent}>
                    <h1 className={styles.title}>
                        Soluções ERP Personalizadas <br />
                        para <span className={styles.highlight}>Distribuidora Safari</span>
                    </h1>
            ...
            <section className={styles.presentation}>
                ...
                <div className={styles.presentationContent}>
                    ...
                    <p className={styles.presentationText}>
                        Desenvolvemos um sistema ERP totalmente personalizado para a Distribuidora Safari,
                        otimizando o controle de estoque, pedidos e faturamento, garantindo maior
                        eficiência operacional e controle em tempo real.
                    </p>
                </div>
            </section>
